...
class DeclaracionBimestralImport implements OnEachRow, WithHeadingRow
{
    public function onRow(Row $row)
    {
        ...
        $DeclaracionBimestral = new DeclaracionBimestral([
        ...
        $DeclaracionBimestral->save(); // Intenta guardar el registro
    
        return $DeclaracionBimestral;
    }
}
